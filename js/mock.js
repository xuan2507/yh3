...
const MOCK_SUBJECTS = [
    ...
    { id: 'accounting', name: 'Accounting', icon: 'fa-calculator', color: '#f97316', time: 45 }
];
...
const MOCK_QUESTIONS = {
    ...
    accounting: [
        { type: 'mcq', q: 'A business purchases inventory on credit for $5,000. The effect on the accounting equation is:', options: ['Assets increase by $5,000; liabilities increase by $5,000', 'Assets decrease by $5,000; equity decreases by $5,000', 'No effect on the accounting equation', 'Assets increase by $5,000; equity increases by $5,000'], a: 0, marks: 1, exp: 'Inventory (asset) increases by $5,000 and Trade payables (liability) increases by $5,000. The equation remains balanced.' },
        { type: 'mcq', q: 'Which of the following is a capital expenditure?', options: ['Wages of factory workers', 'Purchase of a delivery van', 'Electricity bill', 'Raw materials purchased'], a: 1, marks: 1, exp: 'Purchase of a delivery van is capital expenditure (acquisition of a non-current asset). The others are revenue expenditures.' },
        { type: 'mcq', q: 'A company\'s net profit for the year was $45,000. Depreciation of $8,000 was charged, and there was a loss on disposal of machinery of $3,000. What is the profit from operations?', options: ['$50,000', '$40,000', '$56,000', '$34,000'], a: 0, marks: 1, exp: 'Profit from operations = Net profit + Loss on disposal = 45,000 + 3,000 = $50,000 (depreciation is already deducted in arriving at net profit).' },
        { type: 'mcq', q: 'The allowance for doubtful debts is deducted from:', options: ['Cost of sales', 'Trade receivables', 'Trade payables', 'Cash at bank'], a: 1, marks: 1, exp: 'The allowance for doubtful debts is deducted from trade receivables in the statement of financial position to show net realizable value.' },
        { type: 'mcq', q: 'Under the reducing balance method, an asset costing $50,000 is depreciated at 20% per annum. What is the depreciation charge in Year 2?', options: ['$10,000', '$8,000', '$12,000', '$6,000'], a: 1, marks: 1, exp: 'Year 1: 20% × 50,000 = $10,000. CV at start of Year 2 = $40,000. Year 2: 20% × 40,000 = $8,000.' },
        { type: 'mcq', q: 'Which of the following errors would be revealed by a trial balance?', options: ['Commission error', 'Compensating error', 'Omission of a transaction', 'Single-sided entry'], a: 3, marks: 1, exp: 'A single-sided entry (only debit or only credit posted) would cause the trial balance totals to differ. Commission, compensating, and omission errors would not be detected.' },
        { type: 'mcq', q: 'A partner is entitled to interest on capital of $4,000 and a salary of $12,000. The partnership profit for appropriation is $50,000. How much is available for profit sharing?', options: ['$34,000', '$38,000', '$42,000', '$50,000'], a: 0, marks: 1, exp: 'Amount available = 50,000 - 4,000 - 12,000 = $34,000. Interest on capital and salaries are appropriations deducted before residual profit sharing.' },
        { type: 'mcq', q: 'A company issues 100,000 ordinary shares of $1 each at a premium of $0.50. The total cash received is:', options: ['$100,000', '$150,000', '$50,000', '$200,000'], a: 1, marks: 1, exp: 'Issue price per share = $1 + $0.50 = $1.50. Total cash = 100,000 × $1.50 = $150,000. $100,000 goes to share capital, $50,000 to share premium.' },
        { type: 'mcq', q: 'Which inventory valuation method would result in the highest reported profit during a period of rising prices?', options: ['FIFO', 'LIFO', 'Weighted average cost', 'Standard cost'], a: 0, marks: 1, exp: 'FIFO gives the lowest cost of sales (oldest, cheapest inventory is sold first) and therefore the highest gross profit during rising prices.' },
        { type: 'mcq', q: 'The current assets of a business are: Inventory $12,000, Receivables $8,000, Cash $5,000. Current liabilities are $10,000. The acid-test ratio is:', options: ['2.5:1', '1.3:1', '2.0:1', '1.5:1'], a: 1, marks: 1, exp: 'Acid-test = (Current assets - Inventory) / Current liabilities = (25,000 - 12,000) / 10,000 = 13,000 / 10,000 = 1.3:1.' },
        { type: 'structured', q: 'The following information relates to XY Ltd for the year ended 31 December 2024: Revenue $240,000; Cost of sales $150,000; Operating expenses $45,000; Finance costs $5,000; Taxation $12,000. (a) Prepare the income statement. [4] (b) Calculate the gross profit margin and net profit margin. [2]', marks: 6, exp: '(a) Income statement: Revenue 240,000; Cost of sales (150,000); Gross profit 90,000; Operating expenses (45,000); Profit from operations 45,000; Finance costs (5,000); Profit before tax 40,000; Taxation (12,000); Profit for the year 28,000 [4]. (b) Gross margin = 90,000/240,000 × 100 = 37.5% [1]. Net margin = 28,000/240,000 × 100 = 11.7% [1].', ms: 'Marking: (a) gross profit [1], profit from operations [1], profit before tax [1], profit for year [1]. (b) gross margin [1], net margin [1].' },
        { type: 'structured', q: 'Explain the difference between capital expenditure and revenue expenditure, and give two examples of each. [6]', marks: 6, exp: 'Capital expenditure: spending on non-current assets or enhancing their value. Examples: purchase of machinery, building extensions, installation costs. Revenue expenditure: day-to-day running costs. Examples: wages, rent, electricity, repairs and maintenance. Capital expenditure is shown in the SFP; revenue expenditure is shown in the income statement.', ms: 'Marking: capital expenditure defined [1], two examples [2], revenue expenditure defined [1], two examples [2].' },
        { type: 'structured', q: 'A company bought a machine for $80,000 on 1 January 2022. It has an estimated useful life of 5 years and a residual value of $5,000. Using the straight-line method, (a) calculate the annual depreciation, [1] (b) calculate the carrying value at 31 December 2024, [2] (c) state one advantage of the straight-line method. [1]', marks: 4, exp: '(a) Annual depreciation = (80,000 - 5,000) / 5 = $15,000 [1]. (b) Accumulated depreciation after 3 years = 3 × 15,000 = $45,000. Carrying value = 80,000 - 45,000 = $35,000 [2]. (c) Advantage: simple to calculate and understand; consistent charge each year; matches stable benefit pattern [1].', ms: 'Marking: (a) correct formula and answer [1]. (b) accumulated depreciation [1], carrying value [1]. (c) valid advantage [1].' },
        { type: 'structured', q: 'The following balances were extracted from the books of ABC Traders on 31 March 2024: Purchases $85,000; Sales $140,000; Returns inwards $4,000; Returns outwards $3,000; Opening inventory $12,000; Closing inventory $15,000. Prepare the trading account section of the income statement. [5]', marks: 5, exp: 'Trading account: Sales 140,000 less Returns inwards (4,000) = Net sales 136,000. Cost of sales: Opening inventory 12,000 + Purchases 85,000 - Returns outwards (3,000) = 94,000 less Closing inventory (15,000) = 79,000. Gross profit = 136,000 - 79,000 = $57,000.', ms: 'Marking: net sales [1], purchases less returns [1], cost of sales [1], gross profit [1], correct layout [1].' },
        { type: 'structured', q: 'Explain why a bank reconciliation statement is prepared and list three common causes of differences between the cash book and bank statement. [5]', marks: 5, exp: 'Purpose: to identify and explain differences between the cash book balance and the bank statement balance, ensuring the true bank position is known and errors are detected. Causes: (1) Unpresented cheques — cheques issued but not yet cleared. (2) Uncredited deposits — amounts paid in but not yet processed. (3) Bank charges/interest — recorded by bank but not yet in cash book. (4) Standing orders/direct debits. (5) Errors in either book.', ms: 'Marking: purpose explained [2], each valid cause [1 each], maximum 3 causes [3].' },
        { type: 'structured', q: 'Discuss the limitations of using financial ratios to assess business performance. [6]', marks: 6, exp: 'Limitations: (1) Based on historical data, not future prospects. (2) Can be manipulated by window dressing. (3) Different accounting policies affect comparability. (4) Industry averages may not be representative. (5) Ratios alone do not explain causes. (6) Inflation distorts comparisons over time. (7) Snapshot at one date may not be typical. Need to use alongside other information (market trends, management quality, economic conditions).', ms: 'Marking: each valid limitation explained [1 each], maximum 6 marks.' },
        { type: 'structured', q: 'A partnership has two partners, A and B. Their capitals are $60,000 and $40,000 respectively. The partnership agreement provides for: interest on capital at 5% p.a., partner salaries: A $10,000, B $8,000, and profits shared 3:2. The net profit for the year is $55,000. Prepare the appropriation account. [6]', marks: 6, exp: 'Appropriation: Net profit 55,000. Interest on capital: A 3,000, B 2,000. Salaries: A 10,000, B 8,000. Total appropriations = 23,000. Residual profit = 32,000. Share of residual: A 3/5 × 32,000 = 19,200; B 2/5 × 32,000 = 12,800. Total share: A = 3,000 + 10,000 + 19,200 = 32,200; B = 2,000 + 8,000 + 12,800 = 22,800.', ms: 'Marking: interest on capital [1], salaries [1], residual profit [1], A share [1], B share [1], correct layout [1].' },
        { type: 'structured', q: 'Explain the prudence concept and the accruals concept, giving an example of how each is applied in accounting. [6]', marks: 6, exp: 'Prudence (conservatism): do not overstate assets/income or understate liabilities/expenses. Example: creating provision for doubtful debts, valuing inventory at lower of cost and NRV. Accruals (matching): recognize revenue when earned and expenses when incurred, regardless of cash flow. Example: recording accrued wages at year-end, prepayments, depreciation spreading cost over useful life.', ms: 'Marking: prudence defined [1], example [2], accruals defined [1], example [2].' },
        { type: 'structured', q: 'A manufacturing business provides the following information: Direct materials $45,000; Direct labor $35,000; Factory rent $12,000; Factory depreciation $8,000; Office expenses $15,000. (a) Calculate the prime cost. [1] (b) Calculate the factory overheads. [2] (c) Calculate the cost of production. [1]', marks: 4, exp: '(a) Prime cost = Direct materials + Direct labor = 45,000 + 35,000 = $80,000 [1]. (b) Factory overheads = Factory rent + Factory depreciation = 12,000 + 8,000 = $20,000 [2]. (c) Cost of production = Prime cost + Factory overheads = 80,000 + 20,000 = $100,000 [1].', ms: 'Marking: (a) correct calculation [1]. (b) correct items identified [1], correct total [1]. (c) correct answer [1].' },
        { type: 'structured', q: 'The following information relates to a limited company: Issued share capital (ordinary shares $1 each) $200,000; Share premium $50,000; Retained earnings $120,000; 10% Debentures $80,000. (a) Calculate total equity. [1] (b) Explain the difference between ordinary shares and debentures. [4]', marks: 5, exp: '(a) Total equity = 200,000 + 50,000 + 120,000 = $370,000 [1]. (b) Ordinary shares: ownership capital, voting rights, variable dividends (not guaranteed), no fixed return, permanent capital, risk capital. Debentures: loan capital, no voting rights, fixed interest (must be paid), secured against assets, redeemable, lower risk than shares.', ms: 'Marking: (a) correct answer [1]. (b) each valid difference [1 each], maximum 4 marks.' }
    ]
};
