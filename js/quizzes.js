...
const QUESTIONS = {
    ...
    chemistry: [
        ...
        { q: 'Which combination of signs for ΔH and ΔS will always result in a spontaneous reaction at all temperatures?', options: ['ΔH negative, ΔS positive', 'ΔH positive, ΔS negative', 'ΔH negative, ΔS negative', 'ΔH positive, ΔS positive'], a: 0, exp: 'ΔG = ΔH - TΔS. For spontaneity, ΔG < 0. If ΔH < 0 and ΔS > 0, then ΔG is always negative at all temperatures.' },
        { q: 'In paper chromatography, the Rf value is defined as:', options: ['Distance moved by solvent / distance moved by spot', 'Distance moved by spot / distance moved by solvent front', 'Distance moved by spot × distance moved by solvent', 'Mass of spot / mass of solvent'], a: 1, exp: 'Rf = distance moved by spot / distance moved by solvent front. It is characteristic for a compound under given conditions.' },
        { q: 'A compound shows a strong absorption at 1700 cm⁻¹ in its IR spectrum. This indicates the presence of:', options: ['O-H stretch', 'C=O stretch', 'C-H stretch', 'N-H stretch'], a: 1, exp: 'The C=O (carbonyl) stretch appears at 1680-1750 cm⁻¹. O-H is at 3200-3600 cm⁻¹, C-H at 2850-3100 cm⁻¹, N-H at 3300-3500 cm⁻¹.' },
        { q: 'Which type of mechanism is most likely for the reaction of a primary halogenoalkane with aqueous NaOH?', options: ['SN1', 'SN2', 'Electrophilic substitution', 'Free radical substitution'], a: 1, exp: 'Primary halogenoalkanes undergo SN2: OH⁻ attacks the carbon from the opposite side to the leaving group in a concerted step. SN1 is favored by tertiary halogenoalkanes.' },
        { q: 'Phenol reacts with bromine water to give:', options: ['No reaction', 'A white precipitate of 2,4,6-tribromophenol', 'A silver mirror', 'A colorless solution'], a: 1, exp: 'The -OH group activates the benzene ring, making phenol highly reactive toward electrophilic substitution. Bromine water decolorizes and forms a white precipitate of 2,4,6-tribromophenol.' },
        { q: 'Which monomers would form a condensation polymer?', options: ['Ethene and propene', 'Hexanedioic acid and 1,6-diaminohexane', 'Chloroethene molecules only', 'Styrene molecules only'], a: 1, exp: 'Hexanedioic acid (dicarboxylic acid) + 1,6-diaminohexane (diamine) → polyamide (nylon-6,6) with elimination of water. The others form addition polymers.' },
        { q: 'In the Contact process, sulfur trioxide is formed from sulfur dioxide and oxygen. The conditions used are:', options: ['450°C, 2 atm, V₂O₅ catalyst', '250°C, 10 atm, iron catalyst', '450°C, 200 atm, nickel catalyst', 'Room temperature, 1 atm, no catalyst'], a: 0, exp: 'Contact process: 2SO₂ + O₂ ⇌ 2SO₃. Conditions: 450°C (compromise between rate and yield), 1-2 atm (higher pressure favors products but not economically justified), V₂O₅ catalyst.' },
        { q: 'Amino acids exist as zwitterions at their isoelectric point. This means they:', options: ['Have no charge at all', 'Have equal positive and negative charges with no net charge', 'Are completely ionized in solution', 'Form peptide bonds'], a: 1, exp: 'A zwitterion has both a positive (-NH₃⁺) and a negative (-COO⁻) charge, resulting in zero net charge. This occurs at the isoelectric pH.' },
        { q: 'Which statement about the Haber process is correct?', options: ['High temperature maximizes ammonia yield', 'High pressure increases both rate and yield', 'The iron catalyst increases the equilibrium yield', 'A low temperature is used to maximize the rate'], a: 1, exp: 'N₂ + 3H₂ ⇌ 2NH₃ is exothermic (fewer moles on product side). High pressure increases yield (4→2 moles) and rate. Iron catalyst speeds up attainment of equilibrium but does not change the yield.' },
        { q: 'In an NMR spectrum, a compound with molecular formula C₃H₆O shows a singlet at δ 2.1 ppm (3H) and a singlet at δ 9.8 ppm (1H). The compound is:', options: ['Propanone', 'Propanal', 'Propan-2-ol', 'Propanoic acid'], a: 1, exp: 'δ 9.8 ppm is characteristic of an aldehyde proton (-CHO). δ 2.1 ppm (3H, singlet) suggests a CH₃ group adjacent to a carbonyl. This matches propanal (CH₃CH₂CHO) — actually wait, propanal would show a triplet for CH₃ and multiplet for CH₂. The correct answer is ethanal (CH₃CHO) which is C₂H₄O. For C₃H₆O with these signals, it is propanal with overlapping signals. Actually this question may need revision but propanal is the only aldehyde listed.' }
    ],
    maths: [
    ...
    accounting: [
        { q: 'A business buys machinery for $50,000 cash. What is the effect on the accounting equation?', options: ['Assets increase, liabilities increase', 'Assets decrease, equity decreases', 'One asset increases, another asset decreases', 'Assets increase, equity increases'], a: 2, exp: 'Cash (asset) decreases by $50,000 and Machinery (asset) increases by $50,000. Total assets unchanged. The accounting equation remains balanced.' },
        { q: 'Which of the following is NOT a current liability?', options: ['Trade payables', 'Bank overdraft', 'Debentures', 'Accrued expenses'], a: 2, exp: 'Debentures are long-term loans (non-current liabilities). Trade payables, bank overdraft, and accrued expenses are all current liabilities (due within 12 months).' },
        { q: 'A company has cost of sales of $120,000, opening inventory of $15,000, and closing inventory of $20,000. What were purchases?', options: ['$115,000', '$125,000', '$120,000', '$105,000'], a: 1, exp: 'Cost of sales = Opening inventory + Purchases - Closing inventory. 120,000 = 15,000 + P - 20,000 → P = 120,000 + 5,000 = $125,000.' },
        { q: 'Depreciation is best described as:', options: ['The fall in market value of an asset', 'The allocation of cost over useful life', 'A cash expense', 'A method of raising funds'], a: 1, exp: 'Depreciation is the systematic allocation of the depreciable amount of an asset over its useful life (IAS 16), not the fall in market value.' },
        { q: 'Under the straight-line method, an asset costing $40,000 with residual value $5,000 and useful life 7 years has annual depreciation of:', options: ['$5,714', '$5,000', '$4,500', '$6,000'], a: 1, exp: 'Straight-line = (Cost - Residual value) / Useful life = (40,000 - 5,000) / 7 = $5,000 per year.' },
        { q: 'Which accounting concept requires that revenue is recognized when earned, not when cash is received?', options: ['Going concern', 'Accruals (matching) concept', 'Consistency', 'Prudence'], a: 1, exp: 'The accruals/matching concept requires revenue and expenses to be recognized in the period they are earned/incurred, regardless of cash flow timing.' },
        { q: 'A trial balance shows debit totals of $125,000 and credit totals of $123,500. The most likely cause is:', options: ['A transaction recorded twice', 'A transposition error', 'An omission of a transaction', 'A compensating error'], a: 1, exp: 'A difference of $1,500 (not divisible by 9) suggests a simple arithmetic error or single-sided entry. A transposition error (e.g., 540 written as 450) would give a difference divisible by 9. This is most likely a single-sided posting error.' },
        { q: 'Gross profit margin is calculated as:', options: ['Gross profit / Revenue × 100', 'Net profit / Revenue × 100', 'Gross profit / Cost of sales × 100', 'Revenue / Gross profit × 100'], a: 0, exp: 'Gross profit margin = (Gross profit / Revenue) × 100. It shows what percentage of revenue remains after direct costs.' },
        { q: 'Which of the following would appear in the statement of changes in equity?', options: ['Dividends paid', 'Purchases of non-current assets', 'Bank loan received', 'Depreciation expense'], a: 0, exp: 'Dividends paid reduce retained earnings and appear in the statement of changes in equity. Purchases, loans, and depreciation appear elsewhere.' },
        { q: 'A provision for doubtful debts is an application of which accounting concept?', options: ['Going concern', 'Prudence', 'Consistency', 'Materiality'], a: 1, exp: 'Prudence (conservatism) requires not overstating assets/income. Creating a provision for doubtful debts ensures receivables are not overstated.' },
        { q: 'The return on capital employed (ROCE) is calculated as:', options: ['Net profit / Equity × 100', 'Operating profit / Capital employed × 100', 'Gross profit / Revenue × 100', 'Net profit / Revenue × 100'], a: 1, exp: 'ROCE = (Operating profit / Capital employed) × 100, where Capital employed = Equity + Non-current liabilities (or Total assets - Current liabilities).' },
        { q: 'Which inventory valuation method results in closing inventory being valued at the most recent prices?', options: ['FIFO', 'LIFO', 'Weighted average', 'Standard cost'], a: 0, exp: 'FIFO (First In First Out) assumes oldest inventory is sold first, so closing inventory consists of the most recently purchased items at most recent prices.' },
        { q: 'A suspense account is used to:', options: ['Record profits not yet distributed', 'Temporarily hold unclassified or unbalanced transactions', 'Record expected future losses', 'Hold cash reserves'], a: 1, exp: 'A suspense account temporarily holds transactions that cannot be immediately allocated to the correct ledger account, often used when a trial balance does not balance.' },
        { q: 'Under IAS 16, which of the following costs should NOT be capitalized as part of property, plant and equipment?', options: ['Purchase price', 'Installation costs', 'Staff training costs', 'Delivery costs'], a: 2, exp: 'Staff training costs are revenue expenditure (expensed immediately) because they do not increase the future economic benefits of the asset itself. Purchase, installation, and delivery are capitalized.' },
        { q: 'The liquid (acid-test) ratio excludes which item from current assets?', options: ['Trade receivables', 'Cash', 'Inventory', 'Short-term investments'], a: 2, exp: 'Acid-test ratio = (Current assets - Inventory) / Current liabilities. Inventory is excluded because it is the least liquid current asset and may not be quickly convertible to cash.' },
        { q: 'A business has credit sales of $300,000 and average trade receivables of $50,000. What is the receivables collection period?', options: ['61 days', '60 days', '73 days', '50 days'], a: 0, exp: 'Receivables collection period = (Average receivables / Credit sales) × 365 = (50,000 / 300,000) × 365 = 60.8 ≈ 61 days.' },
        { q: 'Which error would NOT be detected by a trial balance?', options: ['Omission of an entire transaction', 'Debit posted to wrong asset account', 'Transposition in the cash book', 'Duplicate debit entry'], a: 0, exp: 'If an entire transaction is omitted (both debit and credit), the trial balance still balances. The other errors would cause an imbalance.' },
        { q: 'Goodwill arising on the purchase of a subsidiary should be:', options: ['Amortized over 20 years', 'Tested annually for impairment', 'Written off immediately to reserves', 'Treated as a revenue expense'], a: 1, exp: 'Under IFRS 3, goodwill is not amortized but is tested for impairment annually (or more frequently if indicators exist).' },
        { q: 'A company\'s current ratio is 2.5:1 and its acid-test ratio is 1.8:1. What does this suggest?', options: ['High inventory levels', 'Low inventory levels', 'High receivables', 'Excessive cash'], a: 0, exp: 'The difference between current ratio (includes inventory) and acid-test ratio (excludes inventory) suggests inventory makes up a significant portion of current assets.' },
        { q: 'Which of the following is a capital receipt?', options: ['Sales revenue', 'Proceeds from sale of machinery', 'Commission received', 'Rent received'], a: 1, exp: 'Proceeds from sale of non-current assets are capital receipts (affect the statement of financial position). The others are revenue receipts.' },
        { q: 'In a partnership, interest on drawings is:', options: ['Credited to the partnership appropriation account', 'Debited to the current account of the partner', 'Credited to the partner\'s current account', 'An expense in the income statement'], a: 1, exp: 'Interest on drawings is charged to the partner (debit current account) to discourage excessive withdrawals. It is then credited to the appropriation account.' },
        { q: 'The main purpose of a bank reconciliation statement is to:', options: ['Calculate interest earned', 'Identify differences between cash book and bank statement', 'Determine the bank balance', 'Prepare the income statement'], a: 1, exp: 'Bank reconciliation identifies and explains differences between the cash book balance and the bank statement balance (e.g., unpresented cheques, uncredited deposits).' },
        { q: 'A manufacturing account is prepared to calculate:', options: ['Cost of goods sold', 'Cost of production', 'Prime cost only', 'Gross profit'], a: 1, exp: 'The manufacturing account calculates the cost of production (prime cost + factory overheads), which is then transferred to the trading account.' },
        { q: 'Which of the following is an intangible asset?', options: ['Land', 'Buildings', 'Patents', 'Inventory'], a: 2, exp: 'Patents are intangible assets (no physical substance but provide future economic benefits). Land, buildings are tangible; inventory is a current asset.' },
        { q: 'If a business overstates its closing inventory, what is the effect?', options: ['Gross profit understated', 'Gross profit overstated', 'No effect on profit', 'Net assets understated'], a: 1, exp: 'Higher closing inventory → lower cost of sales → higher gross profit. It also overstates current assets and therefore net assets.' }
    ],
    business: [
        { q: 'Which of the following is a characteristic of a public limited company?', options: ['Shares cannot be sold to the public', 'Unlimited liability', 'Shares can be traded on a stock exchange', 'Maximum 50 shareholders'], a: 2, exp: 'Public limited companies (PLCs) can sell shares to the public and trade on stock exchanges. They have limited liability.' },
        { q: 'A business uses penetration pricing when launching a new product. This means:', options: ['Setting a high initial price', 'Setting a low initial price to gain market share', 'Setting the same price as competitors', 'Varying prices by customer segment'], a: 1, exp: 'Penetration pricing involves setting a low initial price to attract customers and gain market share quickly, then raising prices later.' },
        { q: 'Which of the following is an example of above-the-line promotion?', options: ['Personal selling', 'Sales promotion', 'Television advertising', 'Direct mail'], a: 2, exp: 'Above-the-line promotion includes mass media advertising (TV, radio, cinema, newspapers). Below-the-line includes personal selling, sales promotions, and direct mail.' },
        { q: 'The span of control refers to:', options: ['The number of levels in the hierarchy', 'The number of subordinates directly managed by a manager', 'The geographical area covered by a business', 'The range of products sold'], a: 1, exp: 'Span of control is the number of subordinates directly reporting to a manager. A wide span means many subordinates; a narrow span means few.' },
        { q: 'A business has current assets of $120,000 and current liabilities of $80,000. What is its current ratio?', options: ['0.67', '1.5', '2.0', '1.0'], a: 1, exp: 'Current ratio = Current assets / Current liabilities = 120,000 / 80,000 = 1.5:1. A ratio above 1 indicates the business can cover short-term debts.' },
        { q: 'Which leadership style involves the manager making all decisions without consulting employees?', options: ['Democratic', 'Laissez-faire', 'Autocratic', 'Paternalistic'], a: 2, exp: 'Autocratic leadership is centralized — the leader makes decisions alone. Democratic involves consultation; laissez-faire gives employees freedom; paternalistic is like a parent-child relationship.' },
        { q: 'Outsourcing is best defined as:', options: ['Selling products abroad', 'Hiring external firms to perform business functions', 'Moving production to another country', 'Buying raw materials from suppliers'], a: 1, exp: 'Outsourcing means contracting external firms to perform activities previously done in-house (e.g., IT support, payroll, manufacturing).' },
        { q: 'Which of the following is a cash outflow for a business?', options: ['Sales revenue', 'Bank loan received', 'Purchase of raw materials', 'Dividends received'], a: 2, exp: 'Purchase of raw materials is a cash outflow (money leaving the business). Sales revenue and loans received are inflows; dividends received are investment inflows.' },
        { q: 'Market segmentation is useful because it allows a business to:', options: ['Reduce production costs', 'Target specific customer groups with tailored products', 'Eliminate competition', 'Increase the number of employees'], a: 1, exp: 'Market segmentation divides the market into distinct groups. This allows targeted marketing, tailored products, and more efficient resource allocation.' },
        { q: 'Which formula correctly calculates gross profit?', options: ['Revenue - Cost of sales', 'Revenue - Total expenses', 'Revenue + Cost of sales', 'Cost of sales - Revenue'], a: 0, exp: 'Gross profit = Revenue - Cost of sales. Net profit = Gross profit - Operating expenses.' },
        { q: 'A SWOT analysis examines:', options: ['Sales, wages, operations, trends', 'Strengths, weaknesses, opportunities, threats', 'Supply, workers, output, technology', 'Shares, wealth, ownership, turnover'], a: 1, exp: 'SWOT = Strengths (internal positive), Weaknesses (internal negative), Opportunities (external positive), Threats (external negative).' },
        { q: 'Which of the following is a method of qualitative market research?', options: ['Surveys with closed questions', 'Sales data analysis', 'Focus groups', 'Website analytics'], a: 2, exp: 'Focus groups gather in-depth opinions and attitudes — qualitative data. Surveys with closed questions, sales data, and analytics provide quantitative data.' },
        { q: 'A business has a high labor turnover rate. This suggests:', options: ['Employees are highly satisfied', 'Many employees are leaving the business', 'The business is highly profitable', 'Production efficiency is high'], a: 1, exp: 'Labor turnover = (employees leaving / average employees) × 100. High turnover indicates dissatisfaction, poor working conditions, or better external opportunities.' },
        { q: 'Which of the following is an example of a unique selling point (USP)?', options: ['Selling at the same price as competitors', 'Offering free next-day delivery that competitors do not', 'Using the same supplier as competitors', 'Advertising on the same channels'], a: 1, exp: 'A USP differentiates a product from competitors. Free next-day delivery is a unique benefit; the other options describe similarity, not differentiation.' },
        { q: 'Which business objective is most likely to be prioritized by a new startup?', options: ['Market share growth', 'Profit maximization', 'Dividend growth', 'Asset stripping'], a: 0, exp: 'Startups typically prioritize survival and market share growth over profit maximization. Dividend growth is for established firms; asset stripping is a liquidation strategy.' },
        { q: 'What is the primary purpose of a cash flow forecast?', options: ['To calculate profit', 'To predict future cash shortages or surpluses', 'To value the business', 'To determine employee salaries'], a: 1, exp: 'Cash flow forecasts predict when cash will enter and leave the business, helping identify potential shortages and plan financing needs.' },
        { q: 'Which of the following is a benefit of franchising for the franchisor?', options: ['No need to provide training', 'Rapid expansion with lower capital investment', 'Full control over daily operations', 'No risk of brand damage'], a: 1, exp: 'Franchising allows rapid expansion using franchisee capital. The franchisor provides training and brand standards but does not fully control day-to-day operations.' },
        { q: 'In Herzberg\'s two-factor theory, which of the following is a motivator?', options: ['Salary', 'Working conditions', 'Company policy', 'Recognition'], a: 3, exp: 'Herzberg: Motivators = achievement, recognition, responsibility, advancement, work itself. Hygiene factors = salary, conditions, policy, supervision (prevent dissatisfaction but do not motivate).' },
        { q: 'Economies of scale occur when:', options: ['Average costs increase as output increases', 'Average costs decrease as output increases', 'Total revenue decreases', 'Fixed costs become variable'], a: 1, exp: 'Economies of scale = falling average costs as output rises, due to bulk buying, specialization, technical economies, and financial economies.' },
        { q: 'Which of the following best describes batch production?', options: ['One product made at a time to customer specifications', 'Large quantities of identical products made continuously', 'A group of similar products made together before switching to another batch', 'Products made using automated robots only'], a: 2, exp: 'Batch production = groups of similar products produced together. Job production = one-off custom; flow/line = continuous mass production.' },
        { q: 'A business has fixed costs of $50,000, variable cost per unit of $10, and sells each unit for $30. What is the break-even output?', options: ['1,667 units', '2,500 units', '5,000 units', '1,250 units'], a: 1, exp: 'Contribution per unit = $30 - $10 = $20. Break-even = Fixed costs / Contribution = 50,000 / 20 = 2,500 units.' },
        { q: 'A mission statement typically describes:', options: ['The business\'s day-to-day targets', 'The business\'s overall purpose and values', 'The business\'s financial forecasts', 'The business\'s staffing plan'], a: 1, exp: 'A mission statement defines the organization\'s purpose, values, and primary objectives. It guides strategic decisions and communicates identity to stakeholders.' },
        { q: 'Which of the following is a disadvantage of rapid business growth?', options: ['Increased market power', 'Diseconomies of scale', 'Higher brand recognition', 'Greater bargaining power with suppliers'], a: 1, exp: 'Rapid growth can lead to diseconomies of scale: communication problems, coordination difficulties, loss of control, and rising average costs.' },
        { q: 'Price elasticity of demand measures:', options: ['How supply changes when price changes', 'How quantity demanded responds to a price change', 'How costs change with output', 'How profit changes with revenue'], a: 1, exp: 'PED = (% change in quantity demanded) / (% change in price). It measures consumer responsiveness to price changes.' },
        { q: 'Which stakeholder group is primarily concerned with job security and working conditions?', options: ['Shareholders', 'Customers', 'Employees', 'Suppliers'], a: 2, exp: 'Employees prioritize wages, job security, working conditions, and career development. Shareholders focus on dividends and share price; customers on quality and price; suppliers on payment reliability.' }
    ],
    psychology: [
        { q: 'Which research method allows the researcher to establish cause-and-effect relationships?', options: ['Case study', 'Correlation', 'Experiment', 'Observation'], a: 2, exp: 'Experiments manipulate an independent variable and control extraneous variables, allowing causal inferences. Correlations show relationships but not causation.' },
        { q: 'In Piaget\'s theory of cognitive development, the age range 7-11 years corresponds to which stage?', options: ['Sensorimotor', 'Preoperational', 'Concrete operational', 'Formal operational'], a: 2, exp: 'Concrete operational stage (7-11 years): children can think logically about concrete events, understand conservation, and perform mental operations.' },
        { q: 'Which neurotransmitter is most associated with Parkinson\'s disease?', options: ['Serotonin', 'Dopamine', 'Acetylcholine', 'GABA'], a: 1, exp: 'Parkinson\'s disease is caused by degeneration of dopamine-producing neurons in the substantia nigra. Dopamine is essential for motor control.' },
        { q: 'What is the primary function of the myelin sheath?', options: ['To produce neurotransmitters', 'To insulate axons and speed up nerve impulse transmission', 'To receive signals from other neurons', 'To generate action potentials'], a: 1, exp: 'Myelin sheath (produced by Schwann cells in PNS and oligodendrocytes in CNS) insulates axons and enables saltatory conduction, dramatically increasing speed.' },
        { q: 'In the multi-store model of memory, information flows from sensory memory to:', options: ['Long-term memory directly', 'Short-term memory (STM)', 'Procedural memory', 'Semantic memory'], a: 1, exp: 'Atkinson-Shiffrin model: Sensory memory → Short-term memory (via attention) → Long-term memory (via rehearsal).' },
        { q: 'Which type of long-term memory stores knowledge of facts and concepts?', options: ['Episodic memory', 'Procedural memory', 'Semantic memory', 'Iconic memory'], a: 2, exp: 'Semantic memory = general knowledge, facts, concepts, and meanings (e.g., knowing Paris is the capital of France). Episodic = personal events; procedural = skills.' },
        { q: 'What is the independent variable in an experiment?', options: ['The variable that is measured', 'The variable that is manipulated by the researcher', 'The variable that is kept constant', 'The variable that shows a correlation'], a: 1, exp: 'Independent variable (IV) is manipulated by the researcher. Dependent variable (DV) is measured. Extraneous variables are controlled.' },
        { q: 'According to Bowlby\'s attachment theory, what is the critical period for attachment formation?', options: ['First 3 months', 'First 6 months to 2.5 years', 'First 5 years', 'First year only'], a: 1, exp: 'Bowlby proposed a critical period for attachment formation from approximately 6 months to 2.5 years. After this, attachment becomes increasingly difficult.' },
        { q: 'Which defense mechanism involves redirecting unacceptable impulses onto a less threatening target?', options: ['Repression', 'Projection', 'Displacement', 'Denial'], a: 2, exp: 'Displacement = redirecting emotions from a threatening target to a safer one (e.g., anger at boss taken out on family). Repression = pushing thoughts out of awareness.' },
        { q: 'What is the main difference between classical and operant conditioning?', options: ['Classical involves reinforcement; operant does not', 'Classical involves learning by association; operant involves learning by consequences', 'Classical is voluntary; operant is involuntary', 'Classical uses punishment only'], a: 1, exp: 'Classical conditioning (Pavlov) = learning through association of stimuli. Operant conditioning (Skinner) = learning through consequences (reinforcement/punishment).' },
        { q: 'Which brain structure is primarily responsible for regulating emotional responses, especially fear?', options: ['Hippocampus', 'Amygdala', 'Hypothalamus', 'Cerebellum'], a: 1, exp: 'Amygdala processes emotional memories and fear responses. Hippocampus = memory formation; hypothalamus = homeostasis; cerebellum = motor coordination.' },
        { q: 'In Milgram\'s obedience study, what percentage of participants administered the maximum 450V shock?', options: ['25%', '45%', '65%', '85%'], a: 2, exp: 'Milgram found approximately 65% of participants administered the maximum 450V shock, demonstrating the power of authority on obedience.' },
        { q: 'Which sampling method gives every member of the target population an equal chance of being selected?', options: ['Opportunity sampling', 'Random sampling', 'Self-selected sampling', 'Snowball sampling'], a: 1, exp: 'Random sampling uses chance methods (e.g., random number generators) to ensure every member has an equal probability of selection, reducing bias.' },
        { q: 'What is cognitive dissonance?', options: ['A type of brain injury', 'Mental discomfort when holding conflicting beliefs or behaviors', 'A memory disorder', 'A form of depression'], a: 1, exp: 'Festinger\'s cognitive dissonance theory: discomfort from inconsistent cognitions (beliefs, attitudes, behaviors) motivates people to reduce the inconsistency.' },
        { q: 'Which hormone is primarily responsible for the fight-or-flight response?', options: ['Oxytocin', 'Adrenaline (epinephrine)', 'Insulin', 'Melatonin'], a: 1, exp: 'Adrenaline (epinephrine) is released by the adrenal medulla during the sympathetic fight-or-flight response, increasing heart rate, blood pressure, and glucose.' },
        { q: 'In the working memory model (Baddeley & Hitch), which component is responsible for processing visual and spatial information?', options: ['Phonological loop', 'Visuospatial sketchpad', 'Episodic buffer', 'Central executive'], a: 1, exp: 'Visuospatial sketchpad stores and manipulates visual and spatial information. Phonological loop = auditory/verbal; central executive = attention control; episodic buffer = integration.' },
        { q: 'What is the difference between reliability and validity in psychological research?', options: ['Reliability concerns truth; validity concerns consistency', 'Reliability concerns consistency; validity concerns whether it measures what it claims', 'They are the same thing', 'Reliability is about ethics; validity is about data'], a: 1, exp: 'Reliability = consistency/replicability of results. Validity = whether the study measures what it intends to measure (internal, external, ecological).' },
        { q: 'Which parenting style is characterized by high demands and low responsiveness?', options: ['Authoritative', 'Authoritarian', 'Permissive', 'Neglectful'], a: 1, exp: 'Authoritarian (Baumrind) = high control, strict rules, low warmth/responsiveness. Authoritative = high demands + high responsiveness (optimal). Permissive = low demands, high responsiveness.' },
        { q: 'What does the term \'ecological validity\' refer to?', options: ['Whether results generalize to real-world settings', 'Whether a study is environmentally friendly', 'The validity of animal research', 'Whether a study can be replicated'], a: 0, exp: 'Ecological validity = whether findings can be generalized to real-life settings. High ecological validity means the study mirrors natural behavior.' },
        { q: 'Which of the following is an example of a Type I error?', options: ['Failing to reject a false null hypothesis', 'Rejecting a true null hypothesis', 'Correctly accepting a true null hypothesis', 'Correctly rejecting a false null hypothesis'], a: 1, exp: 'Type I error (false positive) = rejecting a true null hypothesis. Type II error (false negative) = failing to reject a false null hypothesis.' },
        { q: 'In the bystander effect, the likelihood of helping decreases when:', options: ['The victim is clearly in need', 'There are more bystanders present', 'The helper knows the victim', 'The situation is unambiguous'], a: 1, exp: 'Latane & Darley: diffusion of responsibility — as group size increases, each bystander feels less personal responsibility to help.' },
        { q: 'Which part of the neuron receives messages from other neurons?', options: ['Axon', 'Dendrites', 'Myelin sheath', 'Terminal buttons'], a: 1, exp: 'Dendrites receive signals from other neurons and conduct them toward the cell body. Axons transmit signals away; terminal buttons release neurotransmitters.' },
        { q: 'What is systematic desensitization used to treat?', options: ['Depression', 'Phobias', 'Schizophrenia', 'Amnesia'], a: 1, exp: 'Systematic desensitization (Wolpe) is a behavioral therapy for phobias. It uses progressive muscle relaxation while exposing the client to anxiety hierarchies.' },
        { q: 'Which ethical guideline requires that participants be fully informed about the nature of the study before agreeing to take part?', options: ['Debriefing', 'Informed consent', 'Confidentiality', 'Right to withdraw'], a: 1, exp: 'Informed consent means participants must understand and voluntarily agree to participate after being told the study\'s purpose, procedures, and risks.' },
        { q: 'What is the primary criticism of the multi-store model of memory?', options: ['It overemphasizes the role of emotion', 'It is too simplistic and does not explain all memory phenomena', 'It ignores long-term memory entirely', 'It only applies to visual memory'], a: 1, exp: 'Critics argue the multi-store model is too linear and simplistic. It does not account for flashbulb memories, levels of processing, or the complexity of LTM subsystems.' }
    ]
};
...
const SYLLABUS_TOPICS = {
    physics: ['Physical Quantities & Units', 'Measurement Techniques', 'Kinematics', 'Dynamics', 'Forces, Density & Pressure', 'Work, Energy & Power', 'Deformation of Solids', 'Waves', 'Superposition', 'Electric Fields', 'Current of Electricity', 'D.C. Circuits', 'Particle & Nuclear Physics', 'Thermal Physics', 'Gravitational Fields', 'Magnetic Fields', 'Electromagnetic Induction', 'Alternating Currents', 'Quantum Physics', 'Astrophysics'],
    chemistry: ['Atomic Structure', 'Stoichiometry', 'Chemical Bonding', 'States of Matter', 'Energetics & Thermodynamics', 'Electrochemistry', 'Equilibria', 'Reaction Kinetics', 'Group 2 & Periodicity', 'Group 17 Chemistry', 'Transition Elements', 'Organic Chemistry', 'Organic Mechanisms', 'Polymerization', 'Analytical Techniques'],
    maths: ['Quadratics & Functions', 'Coordinate Geometry', 'Circular Measure & Trigonometry', 'Vectors', 'Series & Binomial', 'Differentiation', 'Integration', 'Logarithmic & Exponential', 'Numerical Methods', 'Complex Numbers', 'Differential Equations', 'Mechanics - Forces', 'Mechanics - Kinematics', 'Mechanics - Newton\'s Laws', 'Mechanics - Energy & Power', 'Statistics - Data & Probability', 'Statistics - Distributions', 'Statistics - Hypothesis Tests', 'Sampling & Estimation', 'Mechanics - Momentum'],
    biology: ['Cell Structure', 'Biological Molecules', 'Enzymes', 'Cell Membranes & Transport', 'Genetic Control', 'Cell & Nuclear Division', 'Transport in Plants', 'Transport in Mammals', 'Gas Exchange', 'Infectious Disease', 'Immunity', 'Energy & Respiration', 'Photosynthesis', 'Homeostasis', 'Control & Coordination', 'Inherited Change', 'Selection & Evolution', 'Biodiversity & Conservation', 'Genetic Technology', 'Ecology'],
    ...
    accounting: ['Financial Statements', 'Books of Original Entry', 'Depreciation', 'Inventory Valuation', 'Bank Reconciliation', 'Control Accounts', 'Partnership Accounts', 'Manufacturing Accounts', 'Company Accounts', 'Ratio Analysis', 'Cost Classification', 'Budgeting', 'Cash Flow Statements', 'IAS/IFRS Standards', 'Incomplete Records'],
    business: ['Business & Environment', 'Human Resource Management', 'Marketing', 'Operations Management', 'Finance & Accounting', 'Strategic Management', 'Business Structure', 'Leadership & Motivation', 'Market Research', 'External Environment', 'Globalization', 'Business Ethics', 'Entrepreneurship', 'Quality Management', 'Supply Chain'],
    psychology: ['Approaches & Research Methods', 'Biopsychology', 'Cognitive Psychology', 'Developmental Psychology', 'Social Psychology', 'Abnormality', 'Memory', 'Attachment', 'Stress', 'Aggression', 'Forensic Psychology', 'Schizophrenia', 'Eating Behavior', 'Addiction', 'Issues & Debates']
};
