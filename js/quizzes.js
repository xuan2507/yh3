...
const SYLLABUS_TOPICS = {
    ...
    accounting: ['Financial Statements', 'Books of Original Entry', 'Depreciation', 'Inventory Valuation', 'Bank Reconciliation', 'Partnership Accounts', 'Manufacturing Accounts', 'Company Accounts', 'Ratio Analysis', 'Control Accounts', 'Cost Classification', 'Budgeting', 'Cash Flow Statements', 'IAS/IFRS Standards', 'Incomplete Records'],
    business: ['Business Organization', 'Marketing', 'Human Resource Management', 'Operations Management', 'Finance & Accounts', 'Business Strategy', 'Leadership & Management', 'Market Research', 'External Environment', 'Business Ethics', 'Globalization', 'Entrepreneurship', 'Quality Management', 'Supply Chain', 'Change Management'],
    psychology: ['Research Methods', 'Biological Psychology', 'Cognitive Psychology', 'Developmental Psychology', 'Social Psychology', 'Abnormal Psychology', 'Memory', 'Attachment', 'Stress', 'Aggression', 'Forensic Psychology', 'Schizophrenia', 'Eating Behavior', 'Addiction', 'Biopsychology']
};
